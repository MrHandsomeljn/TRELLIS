...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, invdepths, absdepths = _C.rasterize_gaussians(*args)
        ...
        return color, radii, invdepths, absdepths

    @staticmethod
    def backward(ctx, grad_out_color, _, grad_out_depth, grad_out_absdepth):
